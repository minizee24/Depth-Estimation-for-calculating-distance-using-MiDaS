...
class midasDepthEstimator():
  ...
  def initializeModel(self):
    modelPath = 'lite-model_midas_v2_1_small_1_lite_1.tflite'
  ...
  def drawDepth(self, processedDisparity):
    return cv2.applyColorMap(processedDisparity, cv2.COLORMAP_OCEAN)
...
if __name__ == '__main__':
  ...
  # Initialize webcam
  camera = cv2.VideoCapture('/content/WIN_20210714_16_06_39_Pro.mp4')
